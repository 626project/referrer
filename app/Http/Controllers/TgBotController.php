    ...
    public function index()
    {
        ...
        switch ($action) {
            case '/start':
                $send_data = [
                    'text' => 'Добрый день!
Мы предлагаем следующие варианты зарубежных платежных карт:

1. *Неименная карта*

   - *Стоимость оформления:* 35 000 руб
   - *Привязка:* К номеру РФ
   - *Пополнение:* Через Сбербанк и Тинькофф
   - *Срок оформления:* 1-2 дня

2. *Киргизия (Вариант 1)*
   - *Тип карты:* Именная, VISA или Mastercard
   - *Стоимость оформления:* 45 000 руб
   - *Валюты:* USD/EUR, дополнительно можно открыть до 14 валют
   - *Пополнение:* По номеру телефона из Т-Банк, с любой карты РФ

3. *Киргизия (Вариант 2)*
   - *Тип карты:* Моновалютная именная VISA
   - *Стоимость оформления:* 45 000 руб
   - *Валюты:* USD или EUR
   - *Пополнение:* SWIFT, Сбербанк и Тинькофф по номеру телефона

4. *Моновалютная карта VISA*

   - *Стоимость оформления:* 45 000 руб
   - *Валюты:* USD или EUR
   - *Пополнение:* Валютный SWIFT, через мобильное приложение (Сбербанк и Тинькофф)

Больше вариантов и подробную информацию можно получить у менеджеров  ☎️',
