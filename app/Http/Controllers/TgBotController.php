    ...
    public function index()
    {
        ...
        switch ($action) {
            case '/start':
                $send_data = [
                    'text' => '*Добрый день!
На данный момент мы можем предложить вам три варианта карт банков Казахстана:*

1️⃣ *вариант*:
На данный момент мы можем предложить Вам дистанционное открытие Мультивалютной карты Master Card в 4х валютах: USD, EUR, RUB, KZT.
...
При первом пополнении счета единоразово списывается комиссия за открытие карты 30 000 тенге (около 5 000 руб., зависит от курса рубль/тенге).
❌ Нежелательно пополнение счетов криптовалютой. Возможна блокировка счетов.

Для оформления карты необходимо:
- Загранпаспорт (первый разворот)
- Доверенность на получение карты - заверенная нотариусом
- ИИН (делает наш представитель)
 ❗ Если Вы находитесь не в России: вопрос доверенности индивидуально обсуждается.

Стоимость дистанционного открытия ИИН, банковского счёта, выпуск карты - 60 000 рублей\*

2⃣ *вариант*:
На данный момент мы можем предложить Вам дистанционное открытие Мультивалютной карты Master Card World Elite в 4х валютах: USD, EUR, RUB, KZT.

Преимущества:
☑ Программа страхования для путешествий до 1 500 000 EUR.
☑ Выделенная линия Call Center 24/7.
☑ Доступ в бизнес залы аэропортов / Программа Lounge Key.
☑ Консьерж-сервис.
☑ Программа доступов в бизнес-залы Mastercard.
...
☑ Исходящие и входящие SWIFT-переводы.
☑ Читается как CREDIT и подходит для RENT CAR.
Годовое обслуживание 60 000 тенге (около 10 000 руб., зависит от курса рубль/тенге)
❌ Нежелательно пополнение счетов криптовалютой. Возможна блокировка счетов.
...
Стоимость дистанционного открытия ИИН, банковского счёта, выпуск карты, получение карты без доверенности - 65 000 рублей\*

3⃣ *вариант*:
Мультивалютная карта VISA в 4 валютах: USD, EUR, RUB, KZT.
Бесплатное годовое обслуживание (подробные тарифы по запросу у менеджера)
☑VIP тариф, куда входит персональный менеджер
☑1200 бизнес залов в аэропортах по всему миру
☑кэш бэк 4%
☑биржевой курс Forex на конвертацию.
☑Удобное приложение банка с возможностью конвертации между своими счетами. Активация интернет банка осуществляется с казахстанской сим-карты (предоставляется в комплекте с картой банка).
☑Входящий SWIFT. ❗ Возможность удаленного выполнения исходящего перевода по системе SWIFT отсутствует.

Для оформления карты необходимо:
- Загранпаспорт (цветной скан первый разворот)
- ИИН (делает наш представитель)

Стоимость дистанционного открытия ИИН, банковского счёта, получение карты без доверенности- 65 000 рублей\*
