    ...
    public function index()
    {
        ...
        switch ($action) {
            case '/start':
                $send_data = [
                    'text' => '*Добрый день!
На данный момент мы можем предложить вам открытие в трёх банках Казахстана:*

1️⃣ *вариант*:
Мультивалютная карта Master Card в 4х валютах (доллар, евро, рубль, тенге) с бесплатным годовым обслуживанием. При первом пополнении счета единоразово списывается комиссия за открытие карты 15 000 тенге (около 2 000 руб., зависит от курса рубль/тенге).
Преимущества:
- Простое и удобное приложение банка с возможностью конвертации между своими счетами.
- Интеграция с российской сим-картой. В момент открытия счёта на Ваш российский номер телефона придёт смс с доступом к банк-клиенту. Вы сразу увидите счета, номер карты и сможете подключить ее к Apple Pay.
- Исходящие и входящие SWIFT-переводы.
- Читается как CREDIT и подходит для RENT CAR.
Ознакомиться более подробно со всеми тарифами банка можно, запросив их у менеджера.
Выпуск пластиковой карты осуществляется в течение 2х недель, далее отправляется на Ваш адрес по России курьерской службой банка (срок доставки от 3х недель). Если есть возможность сделать доверенность по форме банка, то можем получить карту за Вас в Казахстане и отправить Вам (в данном случае срок доставки около недели).
Для оформления карты необходим цветной скан загранпаспорта (со сканера) + ИИН (индивидуальный идентификационный номер). Срок изготовления 3-14 рабочих дней.
Стоимость дистанционного открытия ИИН, банковского счёта, выпуск карты и доставка до крупных городов - 60 тыс .рублей\*

2️⃣ *вариант*:
Мультивалютная карта класса премиум-Mastercard World Black Edition в 4х валютах (доллар, евро, рубль, тенге).
Обслуживание карты 2 000 тенге/месяц (250 руб. зависит от курса рубль/тенге) или бесплатно при депозите 10 000 000 тенге (1 250 000 руб. зависит от курса рубль/тенге).
Преимущества:
- VIP-залы ожидания Lounge Key.
- Бонусы за каждую покупку до 36% от суммы (подробности в тарифах банк, можно запросить у менеджера).
- Исходящие и входящие SWIFT-переводы.
Для оформления карты необходимо цветной скан загранпаспорта, скан ИНН российского, выписку по счёту из любого банка РФ за последние 6 месяцев (откуда будут поступления денежных средств).
Активация интернет банка осуществляется с казахстанской сим-карты (предоставляется в комплекте с картой банка).
Стоимость дистанционного открытия ИИН, банковского счёта, выпуск карты и доставка до крупных городов - 60 тыс .рублей\*
