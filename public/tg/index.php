...
*Оплата делится на 2 платежа: 50% предоплата в момент предоставления скана занранпаспорта и 50% по факту открытия счета.',
        ...
        break;
    case '�.не под�.оди�. ва�.иан�. 1':
    case '�^|не под�^eоди�^b ва�^`иан�^b 2':
    case 'Св�^oза�^b�^l�^a�^o �^a менедже�^`ом':
    case 'Хо�^g�^c �^cзна�^b�^l какие банки о�^bк�^`�^kва�^n�^b �^aей�^gа�^a':
    case '�^sо�^bов о�^dо�^`ми�^b�^l!':
    case '�^=о �^c�^aлови�^oм опла�^b�^k в�^aе о�^bли�^gно. Хо�^g�^c �^zа�^`�^b�^c!':
    case 'Я не �^`езиден�^b РФ и мне �^m�^bо под�^eоди�^b. Хо�^g�^c ка�^`�^b�^c!':
    case 'У мен�^o �^cже е�^a�^b�^l иин и мне �^m�^bо под�^eоди�^b. Хо�^g�^c ка�^`�^b�^c!':
    case '�^|оего воп�^`о�^aа не�^b в �^m�^bом �^aпи�^aке, �^eо�^g�^c зада�^b�^l �^aвой воп�^`о�^a.':
    case 'Хо�^g�^c �^c�^gа�^a�^bвова�^b�^l в ак�^fии':
...
Цену по акции получат первые откликнувшиеся на наше сообщение . Если вам Интересно, нажмите кнопку  ХОЧУ УЧАСТВОВАТЬ  и мы уведомим вас при старте акции!',
    ...
    case '�^tогово�^` о�^dе�^`�^bа':
        ...
        break;
    case '�^zакие док�^cмен�^b�^k н�^cжн�^k дл�^o о�^dо�^`млени�^o ка�^`�^b�^k?':
        $method = 'sendMessage';
        $send_data = [
        ...
        break;
    case 'Хо�^g�^c ка�^`�^b�^c!  �^~�^bп�^`ави�^b�^l �^aкан па�^aпо�^`�^bа':
        $method = 'sendMessage';
        $send_data = ['text' => 'Отправьте скан паспорта для продолжения'];
        break;
    case '�^rе�^`н�^c�^b�^l�^a�^o назад':
        // todo удаление лишних сообщений,
        $method = 'sendMessage';
        $send_data = ['text' => ''];
        break;
    case '�^zак �^o �^aмог�^c пополн�^o�^b�^l ка�^`�^b�^c?':
        $method = 'sendMessage';
        $send_data = [
...
',
        ...
        break;
    case '�^zакие опла�^gива�^n�^b�^a�^o ва�^hи �^c�^aл�^cги?':
        $method = 'sendMessage';
        $send_data = [
            'text' => 'Условия оплаты:
...
2. часть: Оплата 50%. Оплачиваете по факту открытия счета.',
        ...
        break;
    case 'Я не �^`езиден�^b РФ. �^|ог�^c ли �^o пол�^c�^gи�^b�^l ка�^`�^b�^c?':
        $method = 'sendMessage';
        $send_data = [
        ...
        break;
    case 'У мен�^o �^cже е�^a�^b�^l иин, кака�^o �^fена в �^m�^bом �^aл�^c�^gае?':
        $method = 'sendMessage';
        $send_data = [
